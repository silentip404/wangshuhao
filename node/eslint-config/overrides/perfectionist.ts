 ...
 * ## 背景与动机
 *
 * Perfectionist 是一个极其严格的代码排序规范化插件，其全面性和强制性在社区中颇具争议。 然而在团队协作场景下，统一的代码组织顺序能够：
 *
 ...
 *   - 遵循社区约定提升跨项目代码的一致性
 *
 * **设计理念**：这些元素的顺序本质上是「无语义的」，完全可以交由工具统一管理， 将开发者从琐碎的格式化决策中解放出来。
 *
 ...
 *   - 涉及控制流和副作用，绝对不可自动重排
 *
 * **设计理念**：这些元素的组织蕴含开发者的深思熟虑，工具应该克制， 避免用机械规则破坏人类智慧的表达。
 *
 * ## 预期价值
 *
 * 这种「有所为，有所不为」的配置策略带来：
